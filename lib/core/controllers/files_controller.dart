...
class FilesController extends GetxController {
  ...
  Future<File?> saveImageToDirectory(Uint8List image, String fileName) async {
    ...
    final dir = Directory('$directoryPath/temp');
    final File file = File('$directoryPath/temp/$fileName');
